...
# readr
Screening <- read_csv("~/shiny-rmd-APIs-DBs-pharma-session-2018-02-22-23/RMD/5_RMD_Blogdown/data/Sample_ADA_Data_05062017_Screening.csv") %>% mutate(Screening_Cutpoint = params$screening_cut_point) %>%
...
# readr
Confirmatory <- read_csv("~/shiny-rmd-APIs-DBs-pharma-session-2018-02-22-23/RMD/5_RMD_Blogdown/data/Sample_ADA_Data_05062017_Confirmatory.csv")
...
Titer <- read_csv("~/shiny-rmd-APIs-DBs-pharma-session-2018-02-22-23/RMD/5_RMD_Blogdown/data/Sample_ADA_Data_05062017_Titer.csv")
